...
namespace Katabo.Migrations
{
    ...
    [Migration("20230403005336_test1")]
    partial class test1
    {
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8584),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8592),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8600),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8606),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8612),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(8999),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 4, 2, 20, 53, 36, 413, DateTimeKind.Local).AddTicks(9012),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
