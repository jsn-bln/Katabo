...
namespace Katabo.Migrations
{
    ...
    [Migration("20230324041029_orderinstruction")]
    partial class orderinstruction
    {
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2359),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2363),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2367),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2372),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2376),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2563),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 3, 24, 0, 10, 28, 511, DateTimeKind.Local).AddTicks(2568),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
