...
namespace Katabo.Migrations
{
    ...
    [Migration("20230407132847_guest")]
    partial class guest
    {
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5473),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5480),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5487),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5493),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5499),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5791),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 4, 7, 9, 28, 47, 236, DateTimeKind.Local).AddTicks(5802),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
