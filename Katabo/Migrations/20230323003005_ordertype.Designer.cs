...
namespace Katabo.Migrations
{
    ...
    [Migration("20230323003005_ordertype")]
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9553),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9558),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9562),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9566),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9570),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9752),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 3, 22, 20, 30, 4, 981, DateTimeKind.Local).AddTicks(9759),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
