...
namespace Katabo.Migrations
{
    ...
    [Migration("20230322235229_nameonorders")]
    partial class nameonorders
    {
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2403),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2408),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2412),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2416),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2420),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2586),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 3, 22, 19, 52, 29, 121, DateTimeKind.Local).AddTicks(2592),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
