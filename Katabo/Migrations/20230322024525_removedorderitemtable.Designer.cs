...
namespace Katabo.Migrations
{
    ...
    [Migration("20230322024525_removedorderitemtable")]
    partial class removedorderitemtable
    {
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1289),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1293),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1297),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1301),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1305),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1497),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 3, 21, 22, 45, 25, 146, DateTimeKind.Local).AddTicks(1503),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
