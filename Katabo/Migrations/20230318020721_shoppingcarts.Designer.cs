...
namespace Katabo.Migrations
{
    ...
    [Migration("20230318020721_shoppingcarts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Katabo.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDateTime = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(3967),
                            DisplayOrder = 1,
                            Name = "Seafoods"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDateTime = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(3977),
                            DisplayOrder = 2,
                            Name = "Meat"
                        },
                        new
                        {
                            CategoryId = 3,
                            CreatedDateTime = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(3984),
                            DisplayOrder = 3,
                            Name = "Vegetables"
                        },
                        new
                        {
                            CategoryId = 4,
                            CreatedDateTime = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(3992),
                            DisplayOrder = 4,
                            Name = "Fruits"
                        },
                        new
                        {
                            CategoryId = 5,
                            CreatedDateTime = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(3999),
                            DisplayOrder = 5,
                            Name = "Root Crops"
                        });
                });
            ...
            modelBuilder.Entity("Katabo.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            AddressId = 2,
                            Birthday = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(4241),
                        ...
                        new
                        {
                            UserId = 2,
                            AddressId = 1,
                            Birthday = new DateTime(2023, 3, 17, 22, 7, 20, 605, DateTimeKind.Local).AddTicks(4251),
                            Email = "user@user.com",
                            FirstName = "user",
                            Gender = "Female",
                            LastName = "user",
            ...
            modelBuilder.Entity("Katabo.Models.OrderItem", b =>
                {
                    b.HasOne("Katabo.Models.Order", null)
                        .WithMany("OrderItems")
